...
## License
# Under this Software License Agreement (the "Agreement"), Tradify Business Solutions (the "Vendor") grants to the user (the "Licensee") a non-exclusive and non-transferable license (the "License") to use Unidiner POS Solution (the "Software").
